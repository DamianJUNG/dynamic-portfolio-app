# -*- coding: utf-8 -*-
"""동적자산배분백테스트 앱ver0.2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1CrjbVOvFWDltW8R6T-J9PcAb40KabhgF
"""
        ...
        try:
            ...
            for i, current_date in enumerate(self.rebalancing_dates):
                ...
                self.trade_log.append({
                    'date': current_date,
                    'target_weights': {k: round(v, 4) for k, v in target_weights.items() if abs(v) > 1e-6},
